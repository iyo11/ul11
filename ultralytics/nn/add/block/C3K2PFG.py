######################################## CVPR2026 PFGNet by AI Little monster start ########################################
import torch
...
class C3k2_PFG(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        self.m = nn.ModuleList(
            C3k_PFG(self.c, self.c, 2, shortcut, g) if c3k else PFG(self.c, self.c) for _ in range(n))

######################################## CVPR2026 PFGNet by AI Little monster end ########################################