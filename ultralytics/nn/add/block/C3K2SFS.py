...
class Bottleneck_SFSConv(Bottleneck):
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):
        ...
        self.cv1 = SFS_Conv(c1, c_)  # 在这里可以替换一种Conv，也可以都替换。自己可以做一下消融实验
...
class C3k2_SFS(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        self.m = nn.ModuleList(
            C3k_SFSConv(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_SFSConv(self.c, self.c, shortcut, g) for
            _ in range(n))