...
__all__ = ['C3k2_GhostModule_DynamicConv']
...
# ---------
class C3k_GhostModule_DynamicConv(C3):
...
class C3k2_GhostModule_DynamicConv(C2f):
    ...
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        self.m = nn.ModuleList(
            C3k_GhostModule_DynamicConv(self.c, self.c, 2, shortcut, g) if c3k else GhostModule(self.c, self.c) for _ in
            range(n)
        )
...
if __name__ == "__main__":
    ...
    # Model
    # model = C3k2_GhostModule_DynamicConv(64,64)
