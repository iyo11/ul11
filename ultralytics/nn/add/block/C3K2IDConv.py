...
from ultralytics.nn.modules import C3, C3k2

__all__ = ['C3k2_ID', 'C3k2_INB']
...
class C2f_INB(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(InceptionNeXtBlock(self.c) for _ in range(n))
...
class Bottleneck_IDConv(Bottleneck):
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), den=None, e=0.5):
        super().__init__(c1, c2, shortcut, g, k, e)
        c_ = int(c2 * e)  # hidden channels
        self.cv1 = InceptionDWConv2d(c1)  # 在这里可以替换一种Conv，也可以都替换。自己可以做一下消融实验
        self.cv2 = InceptionDWConv2d(c2)


class C3k_IDConv(C3k):
    def __init__(self, c1, c2, n=1, den=None, shortcut=False, g=1, e=0.5, k=3):
        super().__init__(c1, c2, n, shortcut, g, e, k)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(Bottleneck_IDConv(c_, c_, shortcut, g, k=(k, k), den=den, e=1.0) for _ in range(n)))
...
class C3k2_ID(C3k2):
    def __init__(self, c1, c2, n=1, den=None, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        self.m = nn.ModuleList(
            C3k_IDConv(self.c, self.c, 2, den, shortcut, g) if c3k else Bottleneck_IDConv(self.c, self.c, shortcut, g,
...
class INBC3k(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5, k=3):
        ...
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(InceptionNeXtBlock(c_) for _ in range(n)))
...
class C3k2_INB(C2f):
    ...
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(
            INBC3k(self.c, self.c, 2, shortcut, g) if c3k else InceptionNeXtBlock(self.c) for _ in range(n)
        )